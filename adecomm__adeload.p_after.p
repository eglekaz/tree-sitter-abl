...
&ENDIF
 ...
 END CASE.  
    ...
    CASE v:
        ...
        OTHERWISE DO:
            ASSIGN
                editor_font = INTEGER(v) NO-ERROR
                .
    ...
    IF COLOR-TABLE:NUM-ENTRIES < 16 THEN COLOR-TABLE:NUM-ENTRIES = 16 . /* Get each ADE color from the INI file and make sure it is valid. */ GE T-KEY-VALUE SECTION "ProADE" KEY "DividerFgColor" VALUE v.
    CASE v:
        ...
        END.
    END CASE. GE T-KEY-VALUE SECTION "ProADE" KEY "DividerBgColor" VALUE v.
    CASE v:
